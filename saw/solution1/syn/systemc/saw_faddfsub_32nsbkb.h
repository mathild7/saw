...
#ifndef __saw_faddfsub_32nsbkb__HH__
#define __saw_faddfsub_32nsbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(saw_faddfsub_32nsbkb) {
    ...
    SC_CTOR(saw_faddfsub_32nsbkb):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
