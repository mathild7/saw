...
set Interfaces {
    s_axi_CTRL_BUS {
        ...
        registers {{0x10 freq W 0x0 "Data signal of freq" {{0 32 freq W 0 "Bit 31 to 0 Data signal of freq"}}} {0x18 vol W 0x0 "Data signal of vol" {{0 32 vol W 0 "Bit 31 to 0 Data signal of vol"}}} {0x20 user_writing_V W 0x0 "Data signal of user_writing_V" {{0 1 user_writing_V W 0 "Bit 0 to 0 Data signal of user_writing_V"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
set enable_xo_gen 0
set kernel_files {/home/hildeb47/proj/ECE1373_GhostSynth/mods/saw/saw.cpp}
if {$enable_xo_gen} {
